...
//       isValid = false;
//       console.log("Missing one of two required utility files")
//     }
  

//         // Example validation checks
//         if (!formData.ownerName || !leadGen || !salesRep) {
//           isValid = false;
    
//           console.log(leadGen )
//           console.log(salesRep )
//           console.log(formData.ownerName )
//           console.log("Missing either Homeownername , Leadgen, or Salesrep")
//         }
      
//     // Conditional fields
//     if (formData.mainPanelUpgrade === 'yes' && !formData.mpuNotes) {
//       console.log("Missing MPU data")
//       isValid = false;
//     }
  
//     // Dynamic requirement based on program selection
//     if (formData.program === 'Cash' && !depositFile) {
//       console.log("Missing either Program or deposit file")
//       isValid = false;
//     }
  
//     // Ensure notes are filled
//     if (!formData.notes) {
//       console.log("Missing either project notes")
//       isValid = false;
//     }
...
// // Working rep and leadgen email setter here: 
