...
export default function Home() {
  ...
  const { loading, error, data } = useQuery(GET_Enphase_MAP_DATA);
  ...
  const markers = loading ? [] : (data?.GetEnphaseMapData ? formatDataForMarkers(data.GetEnphaseMapData) : []);
...
//   console.log("Markers:", markers); // Add this line


//   return (
//     <>
//       <Head>
//         <title>Enphase Issue Map</title>
//         <meta name="description" content="Voltiac OPS" />
//         <meta name="viewport" content="width=device-width, initial-scale=1" />
//         <link rel="icon" href="/favicon.ico" />
//       </Head>
