...
import { GET_MASTER_MAP_DATA } from '@/gql/mutations/InstallMap'
...
export default function Home() {
  ...
  const { loading, error, data } = useQuery(GET_MASTER_MAP_DATA);
  ...
  const markers = loading ? [] : (data?.GetMasterMapData ? formatDataForMarkers(data.GetMasterMapData) : []);
