...
import { GET_CONSTRUCTON_MAP_DATA } from '@/gql/mutations/ConstructionMapData.js'
...
export default function Home() {
  ...
  const { loading, error, data } = useQuery(GET_CONSTRUCTON_MAP_DATA);
  ...
  const markers = loading ? [] : (data?.GetConstructionMapData ? formatDataForMarkers(data.GetConstructionMapData) : []);
